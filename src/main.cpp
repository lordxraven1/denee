...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Learncoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Learncoin: 2.5 minutes
